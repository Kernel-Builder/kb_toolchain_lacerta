/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.5-bzr/build/objdir/../build/../gcc/gcc-linaro-4.5-bzr/gcc/config/arm/arm.md'.  */
